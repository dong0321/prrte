...
bool prrte_display_allocation = false;
bool prrte_display_devel_allocation = false;
...
bool prrte_errmgr_detector_enable_flag = false;
double prrte_errmgr_heartbeat_period = 5;
double prrte_errmgr_heartbeat_timeout = 10;
